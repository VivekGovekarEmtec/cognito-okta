from service import get_price_change_cancel_data
...
def lambda_handler(event, context):
    ...
    try:
        ...
        lang = get_query_param_value(query_string_params, "lang")
        response_data = get_price_change_cancel_data(lang)
        log.debug("Received response from get_price_change_cancel_data Service")
        if not response_data['data']["cancel_price_change_list"]:
