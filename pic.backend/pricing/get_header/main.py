from service import get_regulated_prices_headers
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_regulated_prices_headers(authorization_number=authorization_number)
        log.debug("Received response from get_station_information Service")
        if not response_data['data']['regulated_prices_headers_list']:
