from service import get_station_info
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_station_info(outlet_ids=outlet_ids,
                                         lang=lang)
        log.debug("Received response from get_station_info Service")
        if not response_data['data']['reset_price_list']:
