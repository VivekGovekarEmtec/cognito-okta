from service import update_pending_review_service
...
log = Log().get_logger_service("mark_survey_as_pending_review_update_service")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = (update_pending_review_service(parsed_payload))
        log.debug("Received response from update_pending_review_service Service")
