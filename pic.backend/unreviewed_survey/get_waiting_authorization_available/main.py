...
from service import get_waiting_authorization_prices_banner

 #path -/priceChange/unreviewedSurvey/getWaitingAuthorizationAvailable
log = Log().get_logger_service("Get waiting authorization prices banner")
...
def lambda_handler(event, context):
    ...
    try:
        response_data = get_waiting_authorization_prices_banner()
