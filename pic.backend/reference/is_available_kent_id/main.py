from service import is_available_kent_id
...
log = Log().get_logger_service("Get is available kent id")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = is_available_kent_id(kent_id)
        log.debug("Received response from is_available_kent_id Service")
