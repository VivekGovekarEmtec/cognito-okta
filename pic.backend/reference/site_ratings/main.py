from service import get_site_rating
...
log = Log().get_logger_service("Get site ratings")
...
def lambda_handler(event, context):
    ...
    try:
        response_data = get_site_rating()
        log.debug("Received response from get_site_rating Service")
