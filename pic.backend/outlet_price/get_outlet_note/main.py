from service import get_pricing_note
...
log = Log().get_logger_service("Get pricing note")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_pricing_note(site_id)
        log.debug("Received response from get_pricing_note Service")
