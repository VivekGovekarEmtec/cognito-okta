...
from service import get_multi_competitors
...
log = Log().get_logger_service("Get pic-national-outlet-price-lambda-getMultiCompetitors")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        get_competitors_data = get_multi_competitors(site_id,lang)
        ...
        return create_response(get_competitors_data)
