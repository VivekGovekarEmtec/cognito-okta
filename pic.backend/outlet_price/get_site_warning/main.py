from service import get_price_hold_warning
...
def lambda_handler(event, context):
    ...
    try:
        ...
        timezone_code = get_query_param_value(query_string_params, "timezone_code", str)

        response_data = get_price_hold_warning(site_id, timezone_code)
        log.debug("Received response from get_price_hold_warning Service")
