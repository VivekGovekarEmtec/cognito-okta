...
from service import get_is_daily_reset_applicable
...
def lambda_handler(event, context):
    log.debug("Entered into get_is_daily_reset_applicable handler")
    ...
    try:
        ...
        result = get_is_daily_reset_applicable(site_id)
