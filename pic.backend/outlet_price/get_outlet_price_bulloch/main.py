from service import get_outlet_price_bulloch
...
log = Log().get_logger_service("Get outlet price bulloch")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_outlet_price_bulloch(site_id, lang)
        log.debug("Received response from get_outlet_price_bulloch Service")
