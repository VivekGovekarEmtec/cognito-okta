...
from service import get_outlet_competitor_price
...
log = Log().get_logger_service("outlet price get_outlet_competirtor_prices")


@log.inject_lambda_context(log_event=True)
def lambda_handler(event, context):
    log.debug("Entered into get_outlet_competirtor_prices handler")
    ...
    try:
        ...
        result = get_outlet_competitor_price(site_id, lang)
