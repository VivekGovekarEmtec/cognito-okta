from service import price_on_hold_validation
...
log = Log().get_logger_service("price on hold validation")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = price_on_hold_validation(site_id, product_id)
        log.debug("Received response from price_on_hold_validation Service")
