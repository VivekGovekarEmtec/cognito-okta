from service import get_outlet_current_price
...
log = Log().get_logger_service("Get outlet price")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_outlet_current_price(site_id, lang)
        log.debug("Received response from get_outlet_current_price Service")
