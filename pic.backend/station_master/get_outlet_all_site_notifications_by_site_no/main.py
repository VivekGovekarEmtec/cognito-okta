...
from service import get_notifications_all_by_site_id
...
def lambda_handler(event, context):
    log.debug("Entered into getOutletAllSiteNotificationsBySiteNo handler")
    ...
    try:
        ...
        result = get_notifications_all_by_site_id(site_id, language)
