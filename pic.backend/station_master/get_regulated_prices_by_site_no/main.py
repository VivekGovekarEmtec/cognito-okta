from service import get_regulated_price_adjustment
...
log = Log().get_logger_service("Get pic-national-station-master-lambda-getRegulatedPricesBySiteNo")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_regulated_price_adjustment(site_id)
