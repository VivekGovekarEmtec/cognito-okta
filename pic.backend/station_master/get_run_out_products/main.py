from service import get_run_out_products
...
log = Log().get_logger_service("Get pic-national-station-master-lambda-getRunOutProducts")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_run_out_products(language)
