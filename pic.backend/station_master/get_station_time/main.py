from service import current_station_time
...
log = Log().get_logger_service("Get pic-national-station-master-lambda-getStationTime")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = current_station_time(site_id)
