from service import get_regulated_price_zone
...
log = Log().get_logger_service("Get pic-national-station-master-lambda-getRegulatedPricesZone")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_regulated_price_zone(language)
