from service import get_tactical_competitors
...
log = Log().get_logger_service("Get tactic competitors")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_tactical_competitors(site_id, language, search_term)
        log.debug("Received response from get_tactical_competitors Service")
