from service import get_reset_time_by_site_id
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_reset_time_by_site_id(site_id)
        log.debug("Received response from get_reset_time_by_site_id Service")
