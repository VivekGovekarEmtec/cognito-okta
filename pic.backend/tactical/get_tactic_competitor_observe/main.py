...
from service import get_tactical_competitors_observe
...
log = Log().get_logger_service("Get tactic competitors observe")
...
def lambda_handler(event, context):
    ...
    try:
        ...
        response_data = get_tactical_competitors_observe(lang)
        log.debug("Received response from get_tactical_competitors_observe Service")
